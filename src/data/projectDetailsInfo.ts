...
const projectDetails = [
    {
        ...
        text: {
            ...
            fin: {
                ...
                description: 'Microsoft Azure Bot Services -palveluja käyttäen loin virtuaalisen avustajan. Se osaa vastata mm. yritystä koskeviin kysymyksiin, mutta sen päätarkoitus on yhdistää käyttäjät inventaarion hallintaan.  Se on yhdistetty QnA Maker Knowledge Base -tietokantaan ja Azures Language Understandingiin (LUIS).',
            }
        }
    },
    {
    ...
    },
    {
        ...
        text: {
            ...
            fin: {
                title: 'Battleships',
                description: 'Reactin ja Webpackin avulla rakennettu klassinen laivanupotus peli, jossa pelaaja pelaa' +
    ...
    },
    {
        ...
        text: {
            en: {
                title: 'Portfolio',
                description: `To help with my work search, I created this portfolio project. I build it using React, Typescript, Bootstrap, and CSS. I wanted the portfolio to be quite simple but full of details and animations. 
The animations are created using the react-animation-on-scroll package and English and finish translations are created using the i18next.`,
            },
            fin: {
                title: 'Portfolio',
                description: 'Työnhaun avuksi loin tämän portfolion  Reactin, Typescriptin, Bootstrapin ja CSS:n avulla. Halusin portfolion olevan melko yksinkertainen, mutta täynnä yksityiskohtia ja animaatioita.\n' +
                    'Osa animaatioista on luotu react-animation-on-scroll -paketin avulla  ja englanninkieliset ja suomalaiset käännökset on luotu i18nextillä.',
            }
        }
    },
];
