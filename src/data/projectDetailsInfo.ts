...
The animations are created using the react-animation-on-scroll package and English and finish translations are created using the i18next.`
      ...
      fin: {
        title: "Portfolio",
        description:
          "Työnhaun avuksi loin tämän portfolion  Reactin, Typescriptin, Bootstrapin ja CSS:n avulla. Halusin portfolion olevan melko yksinkertainen, mutta täynnä yksityiskohtia ja animaatioita.\n" +
